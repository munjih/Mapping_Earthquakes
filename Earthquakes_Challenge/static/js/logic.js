// Create streets view tile layer
...
// Create satellite streets view tile layer
...
// Grabbing tectonic plate GeoJSON data.
d3.json(tectonicPlate).then(function(data) {
    // Creating a layer with the tectonic plate GeoJSON data.
    L.geoJson(data, {
        color: "yellow"
    }).addTo(tectonic);
